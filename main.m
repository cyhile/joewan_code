...
coding_type = {'VQ','SOMP'}; 
data_type ={'devel','valid','test'};  % devel01~20 batches; valid01~20 batches; final21~40 batches
data_dir = 'D:\Action Recognition\MoSIFT code & ConGD\CGD'; %data directory
labelFile_dir = 'D:\Action Recognition\MoSIFT code & ConGD\ConGD_phase_1\train.txt';
resu_file = '.\result.csv';% the final predictioan results for each video.
parameters.feature_type = features_types{4};
parameters.coding_type = coding_type{1};
parameters.data_type = data_type{1}; 
